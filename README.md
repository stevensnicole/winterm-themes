...
[Cascadia Code](https://github.com/microsoft/cascadia-code) became the default font for all profiles automatically generated by Windows Terminal in release 0.11. Cascadia Code is an awesome font for developers, but I'm a fan of [Fira Code](https://github.com/tonsky/FiraCode) and [JetBrains Mono](https://www.jetbrains.com/lp/mono/). If you [downloaded FiraCode](https://github.com/tonsky/FiraCode/releases/download/4/Fira_Code_v4.zip) and installed the fonts from the pre-reqs steps you are ready to go.
